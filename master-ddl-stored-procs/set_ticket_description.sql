...
DROP PROCEDURE commhub_junction.set_ticket_description;
CREATE PROCEDURE commhub_junction.set_ticket_description(
...
-- all good 				
	UPDATE commhub_junction.work_ticket SET description = in_new_desc WHERE work_ticket_id = in_ticket_id;
