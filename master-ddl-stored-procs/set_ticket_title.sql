...
DROP PROCEDURE commhub_junction.set_ticket_title;
CREATE PROCEDURE commhub_junction.set_ticket_title(
	IN in_end_user_token VARCHAR(32),
	IN in_workspace_token VARCHAR(32),
	IN in_ticket_id INT,
	IN in_new_title TEXT
    )
proc_label:BEGIN
...
-- all good 				
	UPDATE commhub_junction.work_ticket SET title = in_new_title WHERE work_ticket_id = in_ticket_id;
