...
DROP PROCEDURE commhub_junction.set_workspace_name;
CREATE PROCEDURE commhub_junction.set_workspace_name(
...
-- all good 				
	UPDATE commhub_junction.workspace SET workspace_name = in_new_name WHERE workspace_id = target_workspace_id;
