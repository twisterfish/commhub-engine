...
DROP PROCEDURE commhub_junction.set_ticket_to_closed;
CREATE PROCEDURE commhub_junction.set_ticket_to_closed(
...
-- all good so far 				
	UPDATE commhub_junction.work_ticket SET work_ticket_status_id = 6 WHERE work_ticket_id = in_ticket_id;
