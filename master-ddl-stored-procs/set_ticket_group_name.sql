...
DROP PROCEDURE commhub_junction.set_ticket_group_name;
CREATE PROCEDURE commhub_junction.set_ticket_group_name(
	IN in_end_user_token VARCHAR(32),
	IN in_workspace_token VARCHAR(32),
	IN in_ticket_group_id INT,
	IN in_new_name VARCHAR(64)
    )
proc_label:BEGIN
...
-- all good 				
	UPDATE commhub_junction.ticket_group SET ticket_group_name = in_new_name WHERE ticket_group_id = in_ticket_group_id AND workspace_id = target_workspace_id;
