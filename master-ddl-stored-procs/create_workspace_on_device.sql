...
DROP PROCEDURE commhub_junction.create_workspace_on_device;
CREATE PROCEDURE commhub_junction.create_workspace_on_device(
	IN in_creator_token VARCHAR(32),
	IN in_new_workspace_token VARCHAR(32),
...
-- create the workspace
	SET new_workspace_uuid = REPLACE(in_new_workspace_token,"-","");
