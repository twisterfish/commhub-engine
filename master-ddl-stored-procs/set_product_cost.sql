DELIMITER $$
DROP PROCEDURE commhub_junction.set_product_cost;

CREATE PROCEDURE commhub_junction.set_product_cost(
...
proc_label:BEGIN
    ...
    INSERT INTO commhub_junction.product_cost_history ( product_id, cost, effective_date ) VALUES(in_product_id,in_cost,FROM_UNIXTIME(in_effective_date));
