...
DROP PROCEDURE commhub_junction.test_create_user_profile;
CREATE PROCEDURE commhub_junction.test_create_user_profile(
...
-- get the test user's internal ID and delete it
-- DO NOT PUT THIS IN PRODUCTION!!!!!
    ...
    DELETE FROM commhub_junction.workspace_members_lkp WHERE member_id = test_user_id;
    DELETE FROM commhub_junction.workspace WHERE workspace_creator_id = test_user_id;
    DELETE FROM commhub_junction.end_user_profile WHERE end_user_id = test_user_id;
    DELETE FROM commhub_junction.ticket_group WHERE ticket_group_creator_id = test_user_id;
	DELETE FROM commhub_junction.end_user WHERE end_user_id = test_user_id;
