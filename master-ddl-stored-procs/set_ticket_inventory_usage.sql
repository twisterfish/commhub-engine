...
DROP PROCEDURE commhub_junction.set_ticket_inventory_usage;
CREATE PROCEDURE commhub_junction.set_ticket_inventory_usage(
	IN in_end_user_token VARCHAR(32),
	IN in_workspace_token VARCHAR(32),
	IN in_ticket_id INT,
	IN in_product_id FLOAT(10,4),
	IN in_product_id_qty FLOAT(10,4)
    )
proc_label:BEGIN
...
-- all good 				
	INSERT INTO commhub_junction.work_ticket_item ( work_ticket_id, product_id, product_id_qty ) VALUES ( in_ticket_id, in_product_id, in_product_id_qty );
