...
DROP PROCEDURE commhub_junction.set_ticket_to_paused;
CREATE PROCEDURE commhub_junction.set_ticket_to_paused(
...
-- all good so far 				
	UPDATE commhub_junction.work_ticket SET running_time = in_new_time, work_ticket_status_id = 3 WHERE work_ticket_id = in_ticket_id AND assigned_to_user_id = requesters_id;
