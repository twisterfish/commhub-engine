DELIMITER $$
DROP PROCEDURE commhub_junction.get_product_by_sku;

CREATE PROCEDURE commhub_junction.get_product_by_sku(
...
proc_label:BEGIN
    ...
    SELECT product_id, vendor_id, product_unit_sold_id, upc, sku, description FROM commhub_junction.product WHERE sku = in_sku AND workspace_id = target_workspace_id;
