...
DROP PROCEDURE commhub_junction.set_ticket_type;
CREATE PROCEDURE commhub_junction.set_ticket_type(
...
-- all good 				
	UPDATE commhub_junction.work_ticket SET work_ticket_type_id = in_new_type WHERE work_ticket_id = in_ticket_id;
